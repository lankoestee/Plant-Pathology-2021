...
class SwinQ2L(nn.Module):
    r""" Swin Transformer and Q2L.
    ...
    Args:
        ...
        hidden_dim (int, optional): Hidden channels from linear projection of backbone output. Defaults to 256.
    ...
    def __init__(self, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 use_checkpoint=False, hidden_dim=256, nheads=8, 
                 encoder_layers=6, decoder_layers=6, **kwargs):
        super().__init__()
        ...
        self.conv = nn.Conv2d(8 * embed_dim, hidden_dim, 1)
